...
class CambiarPasswordView extends StatelessWidget{
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                FadeInUp(duration: Duration(milliseconds: 1000), child: Text("Recuperar contraseña", style: TextStyle(color: Colors.white, fontSize: 40),)),
                SizedBox(height: 10,),
              ],
            ),
          ),
                  ...
                  children: [
                    ...
                    FadeInUp(duration: Duration(milliseconds: 1400),
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              TextFields_Personalizados(controller: emailController, hintText: "Email", obscuredText: false),
                            ],
                          ),
                        )),
                    SizedBox(height: 30,),
                    FadeInUp(duration: Duration(milliseconds: 1500),
                        child: Text("Se enviará un correo de recuperación", style: TextStyle(color: Colors.grey, fontSize: 12),),
                    ),
                    SizedBox(height: 30,),
                    FadeInUp(duration: Duration(milliseconds: 1600), 
                        child: Boton_Personalizado(onPressed: (){}, hintText: "Recuperar contraseña", colorPrimarios: true)
                    ),
                    SizedBox(height: 15,),
                    FadeInUp(duration: Duration(milliseconds: 1500),
                        child: Container(
                          child: Row(
                            ...
                            children: [
                              Text("¿Recordaste la contraseña?", style: TextStyle(color: Colors.grey),),
                              TextButton(
                                onPressed: (){
